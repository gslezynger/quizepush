...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public List<Notification> ListPendingScheduleNotification(){
        ...
        String query = "SELECT  * FROM "+ TABLE_NAME + " where status != '"+STATUS_SHOWN+"' and status != '" + STATUS_SCHEDULED + "'";
    ...
    public List<Notification> ListAllNotShownNotifications(){
        ...
        String query = "SELECT  * FROM "+ TABLE_NAME + " where status != '"+STATUS_SHOWN+"'";
